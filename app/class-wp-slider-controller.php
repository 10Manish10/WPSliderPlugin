...
require_once 'class-wp-slider-model.php';
require_once 'class-wp-slider-view.php';

class WP_Slider_Controller {

	private $view, $model, $update;

	function __construct() {

		$this->model = new WP_Slider_Model($this);	
		$this->view = new WP_Slider_View($this);
